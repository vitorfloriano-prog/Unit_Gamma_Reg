...
ugamma.fit <- function(formula = NULL, data = NULL,
  ...
  for (b in 1:B)
  {
    ...
    if((class(Estimacao.b) != "try-error")&&(class(Estimacao.b.H0) != "try-error"))
    {
      ...
      if((class(Inv.IF.hat.b) != "try-error")&&(class(Inv.IF.til.b) != "try-error")&&(class(Inv.Inv.IF.hat.psi.psi.b) != "try-error"))
      {
